    ...
    return (
        <div>
            {movie && (
                <div className="movie">
                    {movieImage && (
                        <img src={`https://image.tmdb.org/t/p/original/${movieImage.posters[0].file_path}`} alt={movie.title} className="movie__image" />
                    )}
                    <div className="movie__info">
                        ...
                        <div className="movie__genre">{movie.genres.map((genre) => genre.name + ", ")}</div>
